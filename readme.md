...
```
sudo apt install -y xclip sshuttle pipx docker.io docker-compose docker-clean docker-registry gedit golang wireguard stunnel resolvconf seclists feroxbuster
